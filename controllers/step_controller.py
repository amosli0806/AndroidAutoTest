...
class StepController(QObject):
    ...
    def _on_steps_preview(self, steps):
        ...
        if is_dark:
            ...
            row_bg, row_border, row_hover = "#333333", "#4a4a4a", "#3d4652"
            row_border_hover = "#1976d2"
        else:
            container_bg, container_border = "#ffffff", "#d0d0d0"
            title_fg, sub_fg, text_fg = "#1a1a1a", "#999999", "#333333"
            row_bg, row_border, row_hover = "#fafbfc", "#d8dce2", "#eef3f9"
            row_border_hover = "#1976d2"
        ...
        list_layout.setSpacing(8)                      # 步骤卡片之间的间距
